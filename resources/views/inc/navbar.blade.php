                                ...
                                <div class="owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="top_heading_slide">
                                            <ul>
                                                <li><i class="flaticon-security-camera"></i> Wel-come to <a href="index.html#">NHL</a> <span class="hidden-sm hidden-xs">The pride of the Nigeria Navy</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="item">
                                    ...
                                    <nav style="display: block;">
                                        <ul class="nav">
                                            ...
                                            <li><a href="#">services</a>
                                                <ul>
                                                    <li><a href="www.navalbuilding.com" title="">NBCCL</a></li>
                                                    <li><a href="/nhsl" title="">NHSL</a></li>
