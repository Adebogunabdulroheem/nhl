                        ...
                        <div class="row">
                            <div class="sc_tittle_cont_wrapper">
                                <div class="sc_tittle_cont">
                                    <h1>Nigerian Navy Microfinance Bank Limited</h1>
	...
	<div class="row">
	 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			   ...
			   <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="abt_txt">
                        <p class="sc_toppadder30">Nigerian Navy Microfinance Bank Limited is a microfinance bank that was establish with the objective of providing low interest loan services to personnel in the form of soft loans and to interest members of the public. It also accept deposits like savings, target savings, deposits from individuals, group and associations. Nigerian Navy Microfinance Bank Limited is responsible and in charge of the management of all existing loan schemes in the Nigerian Navy. The bank provides other micro finance banking activities as may be provided in the object clause of the company. The bank thrives on the advantages of better understanding of the banking terrain and boast of having the best brains from the fluid banking and finance labour market. Our banking professional are highly committed and possess the sense of ownership that engenders enhanced services delivery.</p>
                    </div>
                </div>
             </div>
           </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 accordionTwo">
                    <div class="abt_heading_wrapper choose_line">
                        <h1 class="sc_bottompadder20">About NNMFBL</h1>
                    </div>
                    <div class="panel-group sc_toppadder50" id="accordionTwoRight">
                            ...
                            <div id="collapseTwoRightone" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                            To be the most innovative micro-finance bank in Nigeria, delivery cost effective solutions to our clients.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightTwo" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                           To use technology driven financial services to better the life of our customers and provide good atmosphere for entrepreneurship and investment.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightFour" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                          The bank’s bouquet of products fall under two broad categories- Deposit and Loan products.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightFive" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                            1.   Safe sail loan (for Naval personnel/ sister services) <br>
                                            2.   Assets acquisition (for naval personnel and others) <br>
                                            3.   Salary advance (for salary accounts holders) <br>
                                            4.   NOWA Group loan (for wives of Naval personnel) <br>
                                            5.   Back to school loan <br>
                                            6.   Contributory loan <br>
                                            7.   LPO financing <br>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                              <a class="collapsed" data-toggle="collapse" data-parent="#accordionTwoRight" href="index.html#collapseTwoRightSix" aria-expanded="false">
                             DEPOSIT PRODUCTS
                              </a>
                            </h4>
                            </div>
                            <div id="collapseTwoRightSix" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                            1.   Savings account <br>
                                            2.   Current account <br>
                                            3.   Kiddoes account <br>
                                            4.   Targets savings <br> 
                                            5.   Fixed Deposit <br>
