                        ...
                        <div class="row">
                            <div class="sc_tittle_cont_wrapper">
                                <div class="sc_tittle_cont">
                                    <h1>Naval building & Construction Company Limited </h1>
	...
	<div class="row">
	 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			   ...
			   <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="abt_txt">
                        <p class="sc_toppadder30">Naval building & Construction Company Limited is a well-established construction and real estate management company with a proven track record. It has an exclusive portfolio of residential, commercial and industrial properties in the Federal Capital Territory, Abuja. The company is engaged in the construction, development and sales of housing units of personnel at affordable prices and to member of the public at the prevailing market prices. Naval Building & Construction Company Limited is involved in procurement of low interest mortgage facilities for both personnel and private individuals interested in purchasing houses in its estate</p>
                        <p class="sc_toppadder10">Naval Building & Construction Limited provides general contracting, construction of roads, culverts, drainage systems, estate water reticulation system and engineering services including major infrastructural design and property development services for both government and commercial entities.</p>
                    </div>
                </div>
             </div>
           </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 accordionTwo">
                    <div class="abt_heading_wrapper choose_line">
                        <h1 class="sc_bottompadder20">About NBCCL</h1>
                    </div>
                            ...
                            <div id="collapseTwoRightone" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                            To be a leading in Nigeria’s building and allied sector
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightTwo" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                           To harness the power of Quality Construction and Building Skills to meet the emerging needs in the Construction/ Building and Allied sectors in line with international best practices.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightThree" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                            •   Design and Development of Housing Estates 
                                            <br>
                                            •   Design & Construction of Public and Commercial Buildings
                                            <br>
                                            •   Drilling of Bore Holes & water Reticulation
                                            <br>
