                ...
                <div id="rev_slider_1050_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                    <ul>
                        ...
                        <li data-index="rs-2939" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1500" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Examples" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="images/engine.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                        ...
                        <div class="row">
                            <div class="sc_tittle_cont_wrapper">
                                <div class="sc_tittle_cont">
                                    <h1>Naval Engineering Services Limited</h1>
    ...
    <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="sc_srv_img_wrapper">
                        <img src="images/engineering.jpg" alt="img" class="img-responsive">
                     </div>
              </div>
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="abt_txt">
                        <p class="sc_toppadder30">Naval Engineering Services Limited (NESL) was established on 20 December 2012 as a subsidiary of the Navy Holdings (NHL) with the objective to provide the Nigerian Navy with the necessary consulting, marine engineering and logistics support as well as service Nigeria’s marine engineering sector recognized to be lifeblood of the nation’s economy in its areas of core competence. Naval Engineering Services Limited has been duly registered at the Corporate Affairs Commission, Abuja, Nigeria and has since early 2013 commenced full business operations.</p>
                    </div>
                </div>
             </div>
           </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 accordionTwo accordionfour">
                   <div class="abt_img">
                       <img src="images/port_2.jpg" alt="img" class="img-responsive">
                   </div>
                </div>
                <!-- /.col-md-6 -->
            </div>
