                ...
                <div id="rev_slider_1050_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                    <ul>
                        ...
                        <li data-index="rs-2939" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1500" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Examples" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="images/shipyard1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
    ...
    <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="sc_srv_img_wrapper">
                        <img src="images/port_3.jpg" alt="img" class="img-responsive">
                     </div>
              </div>
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="abt_txt">
                        <p class="sc_toppadder30">The Navy shipyard Limited was established on 2 April 1990 as a strategic asset to function as a force multiple and as maintenance facility for Nigerian navy vessels in support of naval operations. Subsequently, the Navy Shipyard was mandated to operate commercially for her to sustain naval operations and maintain the staff inherited from the former owners.</p>
                         <p class="sc_toppadder30">Notwithstanding its challenges, NSL has contributed significantly to the operation of the Nigerian Navy as well as development Nigeria’s maritime sector. The Navy Shipyard has also development human capacity through employment and training of Nigeria Navy personnel and civilians. Consequently, the Navy Shipyard is in good stead to support Nigerian Navy operations, develop indigenous capacity for shipbuilding and maintenance as well as support the growth of Nigeria’s maritime sector.</p>
                    </div>
                </div>
             </div>
           </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 accordionTwo">
                    <div class="abt_heading_wrapper choose_line">
                        <h1 class="sc_bottompadder20">About NESL</h1>
                    </div>
                    <div class="panel-group sc_toppadder50" id="accordionTwoRight">
                            ...
                            <div id="collapseTwoRightone" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                            To be the most innovative and robust engineering outfit that meets the emerging and future technology challenges of the Navy and Africa’s maritime industry.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightTwo" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                           To develop innovative engineering solutions that would enhance the Navy’s capability and drive technology growth in Nigeria’s maritime industry.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightThree" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p>
                                            <b>•   Audacity</b> We are not deterred by difficulty or scope. Where others quit, we find a way through.<br>
                                            <b>•   Ingenuity</b> We generate new and authentic ideas relevant to the peculiar requirements of our customers.<br>
                                            <b>•   Integrity</b> We are guided by principles of rectitude and equity. <br>
                                            <b>•   Knowledge</b> We deploy skills and decades of experience to proffer effective solutions of client’s requirements.
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightFour" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p class="sc_toppadder30">
                                           NESL was initially established to provide engineering and logistics services to the Nigerian Navy and extend this expertise to other customers as a source of internally Generated Revenue (IGR). The strategic focus of the company has however transformed to be the most innovative and robust engineering outfit that meets the emerging and future technical challenges of the Nigerian Navy and Africa’s maritime industry.
                                        </p>
                                        <p class="sc_toppadder30">
                                           The Company is still in its fledgling stages of growth and achieving its lofty vision would require some form of sustenance and capacity building. NESL therefore concentrated its efforts on satisfying the Nigerian Navy’s basic requirements as a means of achieving relevance to guaranty sustainable operations. This strategy has however not provided the company with the needed financial strength to attain its goals. In a service industry where the competition has advantages in commercial experience and scale, NESL had to come up with an effective course of action to ensure its survival.
                                        </p>
                                         <p class="sc_toppadder30">
                                           The company has adopted a new strategy to aggressively pursue the production of cost effective and innovation engineering solutions that are well suited for the immediate environment. This is aimed at improving upon the Navy’s capability with cheap and effective products and leveraging on successful ‘spin-offs’ of such developments to meet its long term financial requirements. Relying on the Navy’s teeming number of young and enterprising engineers and experience gathered over time, NESL is designing platforms which would be cheap, effective, durable and capable of being maintained locally. We are very confident of the relevance of our solutions and excited over our new prospects. We intend to enjoy every minute of our journey to the top.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwoRightFive" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                                <div class="panel-body">
                                    <div class="text-accordion">
                                        <p class="sc_toppadder30">
                                            NESL offers diverse services in the following broad categories:
                                        </p>
                                        <p class="sc_toppadder30">
                                            1.   Ship/ Boat Design and Construction. <br>
                                            2.   Logistics and Spares Parts Supports Services.<br>
                                            3.   General Engineering Maintenance and Support Services.<br>
                                            4.   Marine Equipment Installation Services.<br>
                                            5.   Project Consultancy and Management.<br>
                                            6.   Ship Acquisition.<br>
                                            7.   Ship Maintenance and Equipment Repairs.<br>
                                        </p>
                                    </div>
                                </div>
                            </div>
