...
@section('title')
    NAVY CLEARING & FORWARDING SERVICES LIMITED
@endsection
                ...
                <div id="rev_slider_1050_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                    <ul>
                        ...
                        <li data-index="rs-2939" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1500" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Examples" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="images/clearing1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                        ...
                        <div class="row">
                            <div class="sc_tittle_cont_wrapper">
                                <div class="sc_tittle_cont">
                                    <h1>Navy Clearing & Forwarding Services Limited </h1>
    ...
    <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="sc_srv_img_wrapper">
                        <img src="images/clearing1.jpg" alt="img" class="img-responsive">
                     </div>
              </div>
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="abt_txt">
                        <p class="sc_toppadder30">Navy Clearing and Forwarding Services Limited in partnership with a network of professional clearing and forwarding companies offers a variety of clearing and forwarding of goods at all seas and airports. The company’s logistics support services is a joint services provided by Navy Clearing and Forwarding Services Limited and industry leading Logistics Support Companies.</p>
                    </div>
                </div>
             </div>
           </div>
